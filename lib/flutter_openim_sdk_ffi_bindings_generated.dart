...
class FlutterOpenimSdkFfiBindings {
  ...
  void Login(
    ffi.Pointer<BaseListener> callback,
    ffi.Pointer<ffi.Char> operationID,
  ...
  late final _LoginPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<BaseListener>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>>('Login');
  late final _Login = _LoginPtr.asFunction<
      void Function(ffi.Pointer<BaseListener>, ffi.Pointer<ffi.Char>,
          ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>();

  void SetUserListener(
    ffi.Pointer<UserListener> listener,
  ) {
  ...
  late final _SetUserListenerPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<UserListener>)>>(
          'SetUserListener');
  late final _SetUserListener = _SetUserListenerPtr.asFunction<
      void Function(ffi.Pointer<UserListener>)>();

  void SetAdvancedMsgListener(
    ffi.Pointer<AdvancedMsgListener> listener,
  ) {
  ...
  late final _SetAdvancedMsgListenerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<AdvancedMsgListener>)>>('SetAdvancedMsgListener');
  late final _SetAdvancedMsgListener = _SetAdvancedMsgListenerPtr.asFunction<
      void Function(ffi.Pointer<AdvancedMsgListener>)>();

  void SetFriendListener(
    ffi.Pointer<FriendshipListener> listener,
  ) {
  ...
  late final _SetFriendListenerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<FriendshipListener>)>>('SetFriendListener');
  late final _SetFriendListener = _SetFriendListenerPtr.asFunction<
      void Function(ffi.Pointer<FriendshipListener>)>();

  void SetConversationListener(
    ffi.Pointer<ConversationListener> listener,
  ) {
  ...
  late final _SetConversationListenerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<ConversationListener>)>>('SetConversationListener');
  late final _SetConversationListener = _SetConversationListenerPtr.asFunction<
      void Function(ffi.Pointer<ConversationListener>)>();

  void SetSignalingListener(
    ffi.Pointer<SignalingListener> listener,
  ) {
  ...
  late final _SetSignalingListenerPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<SignalingListener>)>>('SetSignalingListener');
  late final _SetSignalingListener = _SetSignalingListenerPtr.asFunction<
      void Function(ffi.Pointer<SignalingListener>)>();
...
final class ConnListener extends ffi.Struct {
  external OnErrorFuncFunc onConnecting;

  external OnConnectSuccessFunc onConnectSuccess;

  external OnConnectFailedFunc onConnectFailed;

  external OnKickedOfflineFunc onKickedOffline;

  external OnUserTokenExpiredFunc onUserTokenExpired;
}

typedef OnErrorFuncFunc = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;
typedef OnConnectSuccessFunc
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;
typedef OnConnectFailedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(
            ffi.Pointer<ffi.Int32> errCode, ffi.Pointer<ffi.Char> errMsg)>>;
typedef OnKickedOfflineFunc
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;
typedef OnUserTokenExpiredFunc
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;

final class BaseListener extends ffi.Struct {
  external OnErrorFunc onError;

  external OnSuccessFunc onSuccess;
}

typedef OnErrorFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(
            ffi.Pointer<ffi.Int32> errCode, ffi.Pointer<ffi.Char> errMsg)>>;
typedef OnSuccessFunc = ffi
    .Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> data)>>;

final class UserListener extends ffi.Struct {
  external OnSelfInfoUpdatedFunc onSelfInfoUpdated;
}

typedef OnSelfInfoUpdatedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> userInfo)>>;

final class AdvancedMsgListener extends ffi.Struct {
  external OnRecvNewMessageFunc onRecvNewMessage;

  external OnRecvC2CReadReceiptFunc onRecvC2CReadReceipt;

  external OnRecvGroupReadReceiptFunc onRecvGroupReadReceipt;

  external OnNewRecvMessageRevokedFunc onNewRecvMessageRevoked;

  external OnRecvMessageExtensionsChangedFunc onRecvMessageExtensionsChanged;

  external OnRecvMessageExtensionsDeletedFunc onRecvMessageExtensionsDeleted;

  external OnRecvMessageExtensionsAddedFunc onRecvMessageExtensionsAdded;

  external OnRecvOfflineNewMessagesFunc onRecvOfflineNewMessages;

  external OnMsgDeletedFunc onMsgDeleted;
}

typedef OnRecvNewMessageFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> message)>>;
typedef OnRecvC2CReadReceiptFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> msgReceiptList)>>;
typedef OnRecvGroupReadReceiptFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> groupMsgReceiptList)>>;
typedef OnNewRecvMessageRevokedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> messageRevoked)>>;
typedef OnRecvMessageExtensionsChangedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> msgID,
            ffi.Pointer<ffi.Char> reactionExtensionList)>>;
typedef OnRecvMessageExtensionsDeletedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> msgID,
            ffi.Pointer<ffi.Char> reactionExtensionKeyList)>>;
typedef OnRecvMessageExtensionsAddedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> msgID,
            ffi.Pointer<ffi.Char> reactionExtensionList)>>;
typedef OnRecvOfflineNewMessagesFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> messageList)>>;
typedef OnMsgDeletedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> message)>>;

final class FriendshipListener extends ffi.Struct {
  external OnFriendApplicationAddedFunc onFriendApplicationAdded;

  external OnFriendApplicationDeletedFunc onFriendApplicationDeleted;

  external OnFriendApplicationAcceptedFunc onFriendApplicationAccepted;

  external OnFriendApplicationRejectedFunc onFriendApplicationRejected;

  external OnFriendAddedFunc onFriendAdded;

  external OnFriendDeletedFunc onFriendDeleted;

  external OnFriendInfoChangedFunc onFriendInfoChanged;

  external OnBlackAddedFunc onBlackAdded;

  external OnBlackDeletedFunc onBlackDeleted;
}

typedef OnFriendApplicationAddedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> friendApplication)>>;
typedef OnFriendApplicationDeletedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> friendApplication)>>;
typedef OnFriendApplicationAcceptedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> friendApplication)>>;
typedef OnFriendApplicationRejectedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> friendApplication)>>;
typedef OnFriendAddedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> friendInfo)>>;
typedef OnFriendDeletedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> friendInfo)>>;
typedef OnFriendInfoChangedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> friendInfo)>>;
typedef OnBlackAddedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> blackInfo)>>;
typedef OnBlackDeletedFunc = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char> blackInfo)>>;

final class ConversationListener extends ffi.Struct {
  external OnSyncServerStartFunc onSyncServerStart;

  external OnSyncServerFinishFunc onSyncServerFinish;

  external OnSyncServerFailedFunc onSyncServerFailed;

  external OnNewConversationFunc onNewConversation;

  external OnConversationChangedFunc onConversationChanged;

  external OnTotalUnreadMessageCountChangedFunc
      onTotalUnreadMessageCountChanged;
}

typedef OnSyncServerStartFunc
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;
typedef OnSyncServerFinishFunc
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;
typedef OnSyncServerFailedFunc
    = ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>>;
typedef OnNewConversationFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> conversationList)>>;
typedef OnConversationChangedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> conversationList)>>;
typedef OnTotalUnreadMessageCountChangedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Int32> totalUnreadCount)>>;

final class SignalingListener extends ffi.Struct {
  external OnReceiveNewInvitationFunc onReceiveNewInvitation;

  external OnInviteeAcceptedFunc onInviteeAccepted;

  external OnInviteeAcceptedByOtherDeviceFunc onInviteeAcceptedByOtherDevice;

  external OnInviteeRejectedFunc onInviteeRejected;

  external OnInviteeRejectedByOtherDeviceFunc onInviteeRejectedByOtherDevice;

  external OnInvitationCancelledFunc onInvitationCancelled;

  external OnInvitationTimeoutFunc onInvitationTimeout;

  external OnHangUpFunc onHangUp;

  external OnRoomParticipantConnectedFunc onRoomParticipantConnected;

  external OnRoomParticipantDisconnectedFunc onRoomParticipantDisconnected;
}

typedef OnReceiveNewInvitationFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> receiveNewInvitationCallback)>>;
typedef OnInviteeAcceptedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> inviteeAcceptedCallback)>>;
typedef OnInviteeAcceptedByOtherDeviceFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> inviteeAcceptedCallback)>>;
typedef OnInviteeRejectedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> inviteeRejectedCallback)>>;
typedef OnInviteeRejectedByOtherDeviceFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> inviteeRejectedCallback)>>;
typedef OnInvitationCancelledFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> invitationCancelledCallback)>>;
typedef OnInvitationTimeoutFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> invitationTimeoutCallback)>>;
typedef OnHangUpFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char> hangUpCallback)>>;
typedef OnRoomParticipantConnectedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(
            ffi.Pointer<ffi.Char> onRoomParticipantConnectedCallback)>>;
typedef OnRoomParticipantDisconnectedFunc = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(
            ffi.Pointer<ffi.Char> onRoomParticipantDisconnectedCallback)>>;
